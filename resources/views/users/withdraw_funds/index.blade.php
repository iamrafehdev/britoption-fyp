    ...
    <div class="row">
      <div class="col-12 col-sm-6 col-lg-6">
        ...
        <div class="box">
          ...
          <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{url('users/withdraw-preview')}}" method="post">
          @csrf
                ...
                <div class="col-md-12 col-12">
                  ...
                  <div class="form-group">
                    <label>Available Balance</label>
                          <input type="text" id="last-name" readonly required="required"  required="" class="form-control" value="{{Auth::user()->balance}}">
                  </div>
                  
                  <div class="form-group">
                    <label>Amount (Note : Minimum withdraw limit is ${{$setting->withdraw_limit}})</label>
                          <input type="number" id="last-name" required="required" required="" name="withdraw_amount" min="{{$setting->withdraw_limit}}" class="form-control">
                  </div>
