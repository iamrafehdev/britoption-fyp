                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                                              ...
                                              <form id="demo-form" action="{{url('users/add_payment')}}" method="post" target="_blank">
                                                @csrf
                                                <input type="hidden" name="payment_method" value="{{$payment_method->id}}">
                                                <input type="hidden" name="package_plan_id" value="{{$packages_plan_id}}">
                                                <input type="hidden" name="guid" value="{{$w_add}}">
                                                <input type="hidden" name="amount" value="{{$amount}}">
                                                <input type="hidden" name="btc_amount" value="{{round($amount/5570,8)}}">
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <table class="data table table-striped no-margin">
                                ...
                                <tr>
                                    ...
                                    <td><strong style="font-size:18px;font-weight:bolder;">$  &nbsp; {{$amount}} </strong>
                                        <br>
                                        <!--<strong style="font-size:18px;font-weight:bolder;">BTC  &nbsp;&nbsp;  {{round($amount/5570,8)}}</strong>-->
                                    </td>
                                </tr>
                                <!--<tr>-->
                                <!--  <th>Wallet</th>-->
                                ...
                                <tr>
                                    <th>"Tx ID"</th>
                                    <td>
                                        <form id="demo-form" action="{{url('users/deposit-funds')}}" method="post" target="_blank">
                                            @csrf
                                            <input type="hidden" name="payment_method" value="{{$payment_method->id}}">
                                            <input type="hidden" name="package_plan_id" value="{{$packages_plan_id}}">
                                            <input type="hidden" name="guid" value="{{$w_add}}">
