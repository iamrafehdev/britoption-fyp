            ...
            <div class="row">
                <div class="col-sm-6">
                    <span>Referral Link : </span><input type="text" class="form-control" readonly
                                                        value=https://britoption.github.io/register?ref={{Auth::user()->username}}>
                    <span style="float:left">Sponsor : </span> <strong>{{$sponsor->username}}</strong>
                </div>
            </div>
            @if($usertype=="free")
                <div class="row">
                ...
                @if($usertype!="free")
                    <!--tiles-->
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <a href="{{url('/users/unilevel-profit')}}">
                                    <div class="box box-body pull-up bg-pink bg-hexagons-white text-center">
                                ...
                                <a href="{{ url('/users/fund_withdraw_history')}}">
                                    <div class="box box-body pull-up bg-info bg-hexagons-white text-center">
                                        <div class="font-size-40 font-weight-200">
                                            $ {{round($withdrawable_balance,2)}}</div>
