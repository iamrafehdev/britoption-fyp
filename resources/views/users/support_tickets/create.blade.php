    ...
    <div class="row">
      <div class="col-6">
        ...
        <div class="box">
          ...
          <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{url('users/support_ticket/store')}}" method="post" enctype="multipart/form-data">
          @csrf
