                                ...
                                <div class="tab-content" style="width:80%">
                                    <div class="tab-pane active show" id="home9" role="tabpanel">
                                        <div class="pad">
                                            ...
                                            <form id="demo-form2" data-parsley-validate
                                                  ...
                                                  action="{{url('admin/commission')}}" method="post">
                                                @csrf
                                                <div class="box-body">
                                                    <div class="row">
                                                        ...
                                                        <!--  <input type="number" id="package-name" required="required" name="direct_refferal" required="" class="form-control" value="{{ $commission->direct_refferal ? $commission->direct_refferal : '' }}">-->
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="number" id="package-name"
                                                                           ...
                                                                           class="form-control"
                                                                           value="{{ $commission->withdraw_commission  }}">
                                                                    <span
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" id="package-name"
                                                                           ...
                                                                           value="{{ $commission ? $commission->level_1 : '' }}">
                                                                    <span
                                                                        class="input-group-addon bg-secondary"> % </span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" id="package-name"
                                                                           ...
                                                                           required="" class="form-control"
                                                                           value="{{ $commission ? $commission->level_2 : '' }}">
                                                                    <span
                                                                        class="input-group-addon bg-secondary"> % </span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" id="package-name"
                                                                           ...
                                                                           required="" class="form-control"
                                                                           value="{{ $commission ? $commission->level_3 : '' }}">
                                                                    <span
                                                                        class="input-group-addon bg-secondary"> % </span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" id="package-name"
                                                                           ...
                                                                           required="" class="form-control"
                                                                           value="{{ $commission ? $commission->level_4 : '' }}">
                                                                    <span
                                                                        class="input-group-addon bg-secondary"> % </span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" id="package-name"
                                                                           ...
                                                                           required="" class="form-control"
                                                                           value="{{ $commission ? $commission->level_5 : '' }}">
                                                                    <span
                                                                        class="input-group-addon bg-secondary"> % </span>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="tab-pane pad" id="withdraw_limit" role="tabpanel">
                                        ...
                                        <div class="col-sm-4 col-6 text-center">
                                            ...
                                            <form id="demo-form2" data-parsley-validate
                                                  class="form-horizontal form-label-left"
                                                  action="{{url('admin/withdarw_limit')}}" method="post">
                                                @csrf
                                                <div class="box-body">
                                                    <div class="row">
                                                        <div class="col-md-12 col-12">
