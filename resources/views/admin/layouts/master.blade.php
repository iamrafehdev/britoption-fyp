...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/assets/vendor_components/bootstrap-switch/switch.css')}}">
...
<script
    src="{{asset('public/assets/vendor_components/echarts-liquidfill-master/dist/echarts-liquidfill.min.js')}}"></script>
