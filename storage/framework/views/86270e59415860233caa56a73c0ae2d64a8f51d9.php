      ...
      <div class="user-panel">
         <div class="ulogo">
             <a href="<?php echo e(url('/admin-dashboard')); ?>">
              ...
              <span style="color:#fff;"><b>Profit </b>Earn</span>
            </a>
        </div>
        <div class="image">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview" >
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo e(url('admin/packages/approved_requests')); ?>" style="color:#fff;">Approved Requests</a></li>
            <li><a href="<?php echo e(url('admin/packages/rejected_requests')); ?>" style="color:#fff;">Rejected Requests</a></li>           
          </ul>
        </li>
        ...
        <li class="treeview" >
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo e(url('admin/withdraw_request_rejected')); ?>" style="color:#fff;">Withdraw Rejected</a></li>
  ...
  <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" style="display: none;">
    <?php echo csrf_field(); ?>
  </form><?php /**PATH /home/profitearn/public_html/resources/views/admin/layouts/_partials/_nav.blade.php ENDPATH**/ ?>