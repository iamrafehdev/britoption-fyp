  <header class="main-header" style="background:#fd961a;">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo e(asset('public/images/user.png')); ?>" class="user-image rounded-circle" alt="User Image">
            </a>
            <ul class="dropdown-menu scale-up">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo e(asset('public/images/user.png')); ?>" class="float-left rounded-circle" alt="User Image">
   ...
   <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" style="display: none;">
            <?php echo csrf_field(); ?>
          </form><?php /**PATH /home/profitearn/public_html/resources/views/admin/layouts/_partials/_header.blade.php ENDPATH**/ ?>
