    ...
    <div class="wrapper">
        <div class="container-fluid user-auth">
			<div class="hidden-xs col-sm-4 col-md-4 col-lg-4">
				<!-- Logo Starts -->
				<a class="logo" href="https://profitearn.io/">
				...
				<div id="carousel-testimonials" class="carousel slide carousel-fade" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						<div class="item item-2">
							<div>
								<blockquote>
									<p>The name of the Second service we provide for you is Cryptocurrency. With cryptocurrency, you can earn great profit after investment. Brit Option cryptocurrency trading enables users to gain high profits
									with small investments. Users are in a position to make a profit whether the cryptocurrency price rises or falls. </p>
						...
						<div class="item item-3">
							<div>
								<blockquote>
									<p>The last one service we provide for you is Gaming Zone. With Gaming Zone, you can earn great profit after investment. There are different types of gaming zones like Arcade Gaming, PC Gaming/Console Gaming, Non-Virtual Gaming Zone (Club based).
			...
			<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
				<!-- Logo Starts -->
				<a class="visible-xs" href="https://profitearn.io/">
                ...
                <input class="form-styling form-control" type="text" name="ref_name" value="<?php echo e($ref_name); ?>" id="ref_name"/>
                </div>
                            <?php if(isset($_GET['ref'])!=NULL): ?>
                            <div class="alert alert-success">
                              Referral Matched.  Name is  : <?php echo e($ref_user->name); ?>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <input type="text" id="username" name="username" onchange="check_username()"  class="form-control" value="" placeholder="Your Username *" required="">
                                <span id="error_username"></span>
                            </div>

                            <div class="form-group">
                                <input type="email" id="email" name="email" class="form-control" value="" placeholder="Emai Address*" required="">
                            ...
                            <div class="form-group">
                                <input type="password" name="password" required="" value="" class="input_pass <?php if ($errors->has('password')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('password'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?> form-control"  placeholder="Enter Password">
                            </div>
				...
				<p class="text-center copyright-text">Copyright © <?php echo date('Y'); ?> Brit Option All Rights Reserved</p>
				<!-- Copyright Text Ends -->
			</div>
		</div>
...
<script>
    ...
    function check_username()
    {
      ...
      $.ajax({
        url:"<?php echo e(route('username_available.check')); ?>",
        method:"POST",
...
</html><?php /**PATH /home/profitearn/public_html/resources/views/auth/register.blade.php ENDPATH**/ ?>
