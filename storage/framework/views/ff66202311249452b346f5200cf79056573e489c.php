        ...
        <div class="row gutters-tiny">
             ...
             <div class="box box-body pull-up bg-danger bg-hexagons-white text-center">
              ...
              <div class="box-body">
                <p class="font-size-40">
                  <strong><?php echo e($activated_packages_total); ?></strong>
                </p>
              </div>
            </a>
          </div>
          ...
          <div class="col-6 col-md-4 col-xl-3">
            <a class="box box-link-pop text-center" href="javascript:void(0)">
              ...
              <div class="box-body">
                <p class="font-size-40">
                  <strong><?php echo e($packages_total); ?></strong>
                </p>
              </div>
            </a>
          </div>
          ...
          <div class="col-6 col-md-4 col-xl-3">
            <a class="box box-link-pop text-center" href="<?php echo e(url('free_users')); ?>">
              <div class="box box-body pull-up bg-info bg-hexagons-white text-center">
                <p class="font-weight-600">Free Users</p>
              </div>
              <div class="box-body">
                <p class="font-size-40">
                  <strong><?php echo e($pending_users_total); ?></strong>
                </p>
              </div>
            </a>
          </div>
          ...
          <div class="col-6 col-md-4 col-xl-3">
            <a class="box box-link-pop text-center" href="<?php echo e(url('paid_users')); ?>">
              <div class="box box-body pull-up bg-pink bg-hexagons-white text-center">
                <p class="font-weight-600">Active Users</p>
              </div>
              <div class="box-body">
                <p class="font-size-40">
                  <strong><?php echo e($active_users_total); ?></strong>
                </p>
              </div>
            </a>
          </div>
          ...
          <div class="col-6 col-md-4 col-xl-3">
            <a class="box box-link-pop text-center" href="<?php echo e(url('banned_users')); ?>">
              <div class="box box-body pull-up bg-pink bg-hexagons-white text-center">
                <p class="font-weight-600">Banned Users</p>
              </div>
              <div class="box-body">
                <p class="font-size-40">
                  <strong><?php echo e(\App\User::where('status',2)->count()); ?></strong>
                </p>
              </div>
            </a>
          </div>
          ...
          <div class="col-6 col-md-4 col-xl-3">
            <a class="box box-link-pop text-center" href="javascript:void(0)">
              ...
              <div class="box-body">
                <p class="font-size-40">
                  <strong><?php echo e($total_withdraw_request); ?></strong>
                </p>
              </div>
            </a>
          </div>
          ...
          <div class="col-6 col-md-4 col-xl-3">
            <a class="box box-link-pop text-center" href="javascript:void(0)">
              ...
              <div class="box-body">
                <p class="font-size-40">
                  <strong>$<?php echo e(round($total_users_balance,2)); ?></strong>
                </p>
              </div>
            </a>
          </div>
          ...
          <div class="col-6 col-md-4 col-xl-3">
            <a class="box box-link-pop text-center" href="javascript:void(0)">
              ...
              <div class="box-body">
                <p class="font-size-40">
                  <strong>$<?php echo e(round($total_deposit,2)); ?></strong>
                </p>
              </div>
            </a>
          </div>
          ...
          <div class="col-6 col-md-4 col-xl-3">
            <a class="box box-link-pop text-center" href="javascript:void(0)">
              ...
              <div class="box-body">
                <p class="font-size-40">
                  <strong>$<?php echo e(round($total_withdraw_funds,2)); ?></strong>
                </p>
              </div>
            </a>
          </div>
            ...
            <a class="box box-link-pop text-center" href="javascript:void(0)">
              ...
              <div class="box-body">
                <p class="font-size-40">
                  <strong>$<?php echo e(round($total_unilevel_funds,2)); ?></strong>
                </p>
              </div>
            </a>
          </div>
            ...
            <a class="box box-link-pop text-center" href="javascript:void(0)">
              ...
              <div class="box-body">
                <p class="font-size-40">
                  ...
                  <strong>$<?php echo e(round($total_earning,2)); ?></strong>
                </p>
              </div>
            </a>
          </div>
...
<div class="tradingview-widget-container">
  ...
  <div class="tradingview-widget-copyright"><a href="https://profitearn.io" rel="noopener" target="_blank"><span class="blue-text"></span></a></div>
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($users->name); ?></td>
                                     <td><?php echo e($package_percentage); ?>%</td>
                                     <td><a href="<?php echo e(url('admin/user-profile/'.$users->id)); ?>">Detail</a></td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/profitearn/public_html/resources/views/admin/dashboard/index.blade.php ENDPATH**/ ?>
