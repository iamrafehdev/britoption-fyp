                                ...
                                <table id="example"
                                    ...
                                    <?php $__currentLoopData = $support_tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo e(url('admin/support_ticket/'.$ticket->id)); ?>"><span
                                                        class="badge badge-pill badge-success">View Detail</span></a>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\profitearn\resources\views/admin/support_tickets/index.blade.php ENDPATH**/ ?>