            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="box box-solid bg-dark">
                        ...
                        <div class="box-body">
                            <form class="form" action="<?php echo e(url('admin/withdraw_request_filter')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-sm-4">
                                    ...
                                    <?php $__currentLoopData = $user_withdraw_funds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $withdraw): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo e(url('admin/withdraw_request/'.$withdraw->id)); ?>"><span
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\profitearn\resources\views/admin/withdraw_funds/withdraw_request.blade.php ENDPATH**/ ?>