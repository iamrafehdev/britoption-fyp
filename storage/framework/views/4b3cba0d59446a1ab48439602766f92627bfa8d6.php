...
endif; ?> form-control" name="email" value="<?php echo e(old('email')); ?>" placeholder="Your Email *">
...
if (isset($messageCache)) { $message = $messageCache; }
							...
							<!-- Input Field Starts -->
							<div class="form-group">
                                <input type="password" name="password" class="input_pass <?php if ($errors->has('password')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('password'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?> form-control" value="" placeholder="Enter Password">
...
if (isset($messageCache)) { $message = $messageCache; }
                                 ...
                                 <div class="g-recaptcha"
                                      data-sitekey="6LfRUekUAAAAAAzbcp_-AKme9wxWbxVtXwSPvbPz">
                                 </div>
							<!-- Input Field Ends -->
...
</html><?php /**PATH /home/profitearn/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>
