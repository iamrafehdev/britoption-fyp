...
<script>
  ...
  gtag('config', 'UA-160410463-1');
                            ...
                            <ul class="nav navbar-nav">
                                <li><a class="active" href="<?php echo e(url('/')); ?>">home</a></li>
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="<?php echo e(url('company_profile')); ?>">Company profile</a></li>
                                        <li><a href="<?php echo e(url('motivational_banner')); ?>">Motivational Banner</a></li>
                                        <li><a href="<?php echo e(url('promo_banner')); ?>">Promo Banners</a></li>
                                    </ul>
                                </li>
        ...
        </header><?php /**PATH /home/profitearn/public_html/resources/views/frontend/layouts/_partials/_header.blade.php ENDPATH**/ ?>