...
?>
    ...
    <section class="content">
        <div class="row">
            <div class="col-sm-6">
                 <span>Referral Link : </span><input type="text" class="form-control" readonly value=https://profitearn.io/register?ref=<?php echo e(Auth::user()->username); ?>>
        ...
        <!--tiles-->
            ...
            <a href="<?php echo e(url('/users/fund_withdraw_history')); ?>">
              <div class="box box-body pull-up bg-danger bg-hexagons-white text-center">
                  <div class="font-size-40 font-weight-200">$ <?php echo e(round(Auth::user()->balance,2)); ?></div>
                  <div>Balance</div>
              </div>
              </a>
            </div>
            ...
            <a href="#">
                ...
                ?>
              <div class="box box-body pull-up bg-danger bg-hexagons-white text-center">
                  <div class="font-size-40 font-weight-200"><?php echo e(round(($total_roi+$level_amount)*100/$total_investment,2)); ?>%</div>
...
<div class="tradingview-widget-container">
  <div class="tradingview-widget-container__widget"></div>
  <div class="tradingview-widget-copyright"><a href="#" rel="noopener" target="_blank"><span class="blue-text">Forex Rates</span></a> by Brit Option</div>
...
<div class="tradingview-widget-container">
  <div class="tradingview-widget-container__widget"></div>
  <div class="tradingview-widget-copyright"><a href="#" rel="noopener" target="_blank"><span class="blue-text">Technical Analysis for EURUSD</span></a> by Brit Option</div>
  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        // Set chart options
        var options = {'title':'Account Overview',
                       'width':600,
                       'height':400};
...
<?php echo $__env->make('users.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/profitearn/public_html/resources/views/users/dashboard/index.blade.php ENDPATH**/ ?>
