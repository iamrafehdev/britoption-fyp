...
<div class="content-wrapper" style="min-height: 1923.5px;">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
            <a href="<?php echo e(url('admin/unilevel-tree/'.$users->id)); ?>">
              <div class="box box-body pull-up bg-danger bg-hexagons-white text-center">
				 ...
				 <table id="example" class="table table-striped no-margin table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo e($latest_packages->upackage->package_name); ?></td>
                      <td><?php echo e($latest_packages->trx_id); ?></td>
                      <td><?php echo e($latest_packages->daily_profit); ?> %</td>
                      <td>
                          
                             <?php if(empty($latest_packages->package_status)): ?>
                              
                            
                                  <?php if($latest_packages->payment_status == 1): ?>
                                  <span class="label label-success">Active</span>
                                  <?php endif; ?>
                                  <?php if($latest_packages->payment_status == 2): ?>
                                  <span class="label label-warning">Pending</span>
                                  <?php endif; ?>
                                  <?php if($latest_packages->payment_status == 3): ?>
                                  <span class="label label-danger">Rejected</span>
                                  <?php endif; ?>
                                  <span class="label label-danger"><a onclick="loadModal(<?php echo e($latest_packages->id); ?>)">Action</a></span>
                           <?php else: ?>
                    ...
                    <div id="myModal" class="modal fade" role="dialog">
                      <div class="modal-dialog">
                        ...
                        <!-- Modal content-->
                        <form action="<?php echo e(url('admin/change_user_package_status')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  <input type="hidden" name="userpackageID" id="userpackageID">
              ...
              <div class="tab-pane" id="daily_earning">
                 ...
                 <tbody>
                    ...
                    <tr>
                      ...
                      <td>$<?php echo e($daily_profit->total_amount); ?></td>
                      <td class="hidden-phone"><?php echo e(round($daily_profit->amount,2)); ?>%</td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/profitearn/public_html/resources/views/admin/users/user_profile.blade.php ENDPATH**/ ?>