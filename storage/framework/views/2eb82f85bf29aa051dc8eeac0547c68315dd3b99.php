...
if (isset($messageCache)) { $message = $messageCache; }
                ...
                <div class="form-group row mb-0">
                    <div class="col-md-6 offset-md-4">
                        ...
                        <span>Already have an account <a href="<?php echo e(url('/login')); ?>">Go to login</a></span>
                    </div>
                </div>
            </form>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/profitearn/public_html/resources/views/users/auth/register.blade.php ENDPATH**/ ?>