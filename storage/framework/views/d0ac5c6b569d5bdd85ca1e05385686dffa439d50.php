                            ...
                            <div class="contact-page-info">
                                ...
                                <div class="contact-info-box">
                                    ...
                                    <div class="contact-info-box-content">
                                        ...
                                        <p>contact@profitearn.io<br>info@profitearn.io</p>
                                    </div>
                                </div>
								<!-- Contact Info Box Ends -->
                                ...
                                <div class="contact-info-box">
                                    ...
                                    <div class="contact-info-box-content">
                                        ...
                                        <div class="social-contact">
                                            <ul>
                                                <li class="facebook"><a href="https://web.facebook.com/profitearn.io" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                                <li class="twitter"><a href="https://twitter.com/profit_earn" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                                <li class="google-plus"><a href="https://www.youtube.com/channel/UCclIYWH5B6KovT3iVE9lwIw/videos?view_as=subscriber" target="_blank"><i class="fa fa-youtube"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/profitearn/public_html/resources/views/frontend/contact_us/index.blade.php ENDPATH**/ ?>
